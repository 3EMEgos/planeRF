...
@callback(
    ...
    [State("angle-input", "value"), State("frequency-input", "value")],
)
    ...
    [
        ...
        dbc.Row(
            [
                dbc.Col(
                    [
                        html.H5("Input Parameters", style={"textAlign": "center"}),
                        html.H6(
                            ["Angle of Incidence (", html.Sup("o"), ")"],
                            style={"display": "inline-block", "margin-right": 25},
                        ),
                        dcc.Input(
                            id="angle-input",
                            type="number",
                        ...
                        html.H6(
                            "Frequency (MHz)",
                            style={"display": "inline-block", "margin-right": 43},
                        ),
                        dcc.Input(
                            id="frequency-input",
                            type="number",
...
layout = dbc.Container(
    [
        html.H4(
            "Plane Wave Incident onto PEC Ground Plane",
