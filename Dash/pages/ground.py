...
@callback(
    ...
    [State('efield-input', 'value'), State('angle-input', 'value'), State('frequency-input', 'value')]
)
...
Layout_Ground = html.Div([
            ...
            dbc.Row([
                ...
                dbc.Col([
                        ...
                        html.H4('Input Parameters',style={'color': 'Teal','font-weight': 'bold'}),

                        html.Br(),

                        html.H6('Ground Type', style={'color': 'Teal','font-weight': 'bold'}),
                        
                        dcc.RadioItems(id = 'Ground_raditem',              
                                    options=[{'label': 'PEC Ground', 'value': 'PEC Ground'},
                                                {'label': 'Real Ground', 'value': 'Real Ground'}],
                                    value ='PEC Ground', inline = False),

                        html.Br(),
                
                        html.H6(['Incident e-field Strengh (V/m)'],style={'color': 'Teal','font-weight': 'bold'}),

                        dcc.Input(id='efield-input', 
                                    type='number', 
                                    placeholder='',
                                    style={'width':'40%'}),
                        ...
                        html.H6(['Angle of Incident (', html.Sup('o'),')'], style={'color': 'Teal','font-weight': 'bold'}),
                        ...
                        html.H6('Frequency (MHz)', style={'color': 'Teal','font-weight': 'bold'}),
...
layout = dbc.Container(
                [html.H4('Plane Wave Oblique Incident onto PEC or Real Ground: TE and TM',
