...
card_main1 = dbc.Card(
    [
        dbc.CardImg(src="/assets/image-1.png", top=True, bottom=False,
        ...
        dbc.CardBody(
            [
                ...
                dbc.CardLink("Ground Plane Reflection", href="/ground", target="_blank"),
            ]
        ),
    ],
    color="dark",   
...
card_main2 = dbc.Card(
    [
        dbc.CardImg(src="/assets/image-2.png", top=True, bottom=False,
                    title="Image by Vitas"),
        dbc.CardBody(
            [
...
layout = dbc.Container([
            html.H4('The three musketeers of online RF dosimetry',style={'textAlign':'center',"margin-bottom": "0px"}),
            html.Hr(),
            dbc.Row([dbc.Col(card_main1, width=3),
                dbc.Col(card_main2, width=3)], justify="around")
        ]
    )
